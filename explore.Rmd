...
samples <- sapply(lines, function(lns) {
    sample(lns, length(lns) / 20, replace = FALSE)
})
...
print(object.size(meltedChar), units = "MB")
```
...
print(object.size(tokens_all), units = "MB")
print(object.size(tokens_nosw), units = "MB")
...
print(object.size(tkfreq.uni), units = "MB")
print(object.size(uniplot.fr), units = "MB")
```
...
print(object.size(tkfreq.bi), units = "MB")
print(object.size(tk.bi), units = "MB")
...
print(object.size(tkfreq.tri), units = "MB")
...
Many of the trigrams, on the other hand, contain one (e.g., "thanks for the") or even two ("the first time") non-stop words. 
